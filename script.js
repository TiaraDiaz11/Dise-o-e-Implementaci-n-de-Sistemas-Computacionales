...
function renderProductos(lista) {
    ...
    lista.forEach(producto => {
        ...
        productGrid.innerHTML += `
            <div class="product-card" data-id="${producto.id}" data-nombre="${producto.nombre}" data-marca="${producto.marca}"
                data-precio="${producto.precio}" data-genero="${producto.genero}" data-tipo="${producto.tipo}">
...
function configurarEventosProductos() {
    ...
    corazones.forEach(corazon => {
        corazon.addEventListener("click", () => {
            ...
            if (existe) {favoritos = favoritos.filter(item => item.id !== id);
                corazon.textContent = "♡";
...
function actualizarCarrito() {
    ...
    function actualizarFavoritos() {
        ...
        listaFavoritos.innerHTML = `
            <p class="carrito-vacio">No tenés perfumes favoritos.</p>
        `;
        return;
    }
    ...
    document.querySelectorAll(".eliminar-favorito")
        ...
        abrirFavoritos.addEventListener("click", () => {modalFavoritos.classList.add("activo");
            actualizarFavoritos();
        });
        
        cerrarFavoritos.addEventListener("click", () => {modalFavoritos.classList.remove("activo");
        ...
        botonContacto.addEventListener("click", e => {e.preventDefault();
